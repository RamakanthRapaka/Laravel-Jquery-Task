                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status_code == '200') {
                                ...
                                $(".alert").empty();
                                var validationerror = "<strong>Success! </strong> Item Selected!";
                            ...
                            if (data.status_code == '422') {
                                ...
                                $(".alert").empty();
                                var validationerror = "<strong>Error! </strong> Something went wrong!";
                                $(".alert").attr('class', 'alert alert-danger alert-dismissible fade in');
                                $(".alert").append(validationerror);
                                $(".alert").fadeTo(2000, 500).slideUp(500, function () {
                                    $(".alert").slideUp(500);
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status_code == '200') {
                                ...
                                $(".alert").empty();
                                var validationerror = "<strong>Success! </strong> Item Sent Back!";
                                $(".alert").attr('class', 'alert alert-success alert-dismissible fade in');
                                $(".alert").append(validationerror);
                                $(".alert").fadeTo(2000, 500).slideUp(500, function () {
                                    $(".alert").slideUp(500);
